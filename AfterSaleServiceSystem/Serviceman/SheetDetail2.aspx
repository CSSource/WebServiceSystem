...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../js/print/LodopFuncs.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        orient 页面方向 1纵向 2横向
        */
        function Print(orient) {
            try {
                LODOP = getLodop(document.getElementById('LODOP_OB'), document.getElementById('LODOP_EM'));
                if ((LODOP != null) && (typeof (LODOP.VERSION) != "undefined")) {
                    //LODOP.SET_PRINT_PAGESIZE(int,int,int,string) 
                    //参数说明：int 1 纵向 2 横向
                    //         int 宽度
                    var style = "<style></style>";
                    LODOP.SET_PRINT_PAGESIZE(orient, 0, 0, "A4");
                    LODOP.ADD_PRINT_HTM("0%", "0%", "100%", "100%", style + document.getElementById("printDiv").innerHTML);
                    LODOP.SET_PRINT_STYLEA(1, "Horient", 2); //水平居中
                    LODOP.PREVIEW();
                }
                else {
                    ShowDownLoadLodop();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    <div id="dialog" title="下载打印插件" style="display: none;">
        <p>
            <a href='/js/print/install_lodop32.zip'>下载插件</a></p>
        <p style='color: Red;'>
            安装完成后，请重启浏览器</p>
    </div>
    <div class="printDiv" id="printDiv">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource_Custom" runat="server" 
            DeleteMethod="Delete" OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataBySheetid"
        ...
        <asp:FormView ID="FormView_custom" runat="server" DataKeyNames="id" 
            CssClass="Fillstyle">
            <ItemTemplate>
        ...
        <asp:FormView ID="FormView_report" runat="server" DataKeyNames="id" DataSourceID="ObjectDataSource_report"
            ...
            <EditItemTemplate>
                ...
                <asp:Button ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Update"
                    Text="保存" />
                <%--<asp:Button ID="Button1" runat="server" CausesValidation="True" CommandName="Print"
                    OnClientClick="Print(1); return false;" Text="打印" />--%>
            </EditItemTemplate>
            <InsertItemTemplate>
                <table style="width: 100%;" border="2">
                    <tr>
